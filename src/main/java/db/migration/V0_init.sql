...
-- Started on 2024-02-12 18:11:58
...
--
-- TOC entry 2351 (class 1262 OID 16401)
-- Name: ecommerce-2024; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "ecommerce-2024" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'Portuguese_Brazil.1252' LC_CTYPE = 'Portuguese_Brazil.1252';


ALTER DATABASE "ecommerce-2024" OWNER TO postgres;

\connect -reuse-previous=on "dbname='ecommerce-2024'"
...
BEGIN
	...
	if (existe <= 0) then
		RAISE EXCEPTION 'Não foi encontrado o ID e PK da pessoa para realiar a associação do cadastro';
		end if;
		end if;
		return new;
END;
...
--
-- TOC entry 222 (class 1255 OID 17065)
...
CREATE TABLE public.conta_pagar (
    ...
    CONSTRAINT conta_pagar_status_check CHECK (((status)::text = ANY ((ARRAY['COBRANCA'::character varying, 'VENCIDA'::character varying, 'ABERTA'::character varying, 'QUITADA'::character varying, 'RENEGOCIADA'::character varying, 'ALUGUEL'::character varying, 'FUNCIONARIO'::character varying])::text[])))
);
...
CREATE TABLE public.cup_desc (
    ...
    datavalidade_cupom date NOT NULL,
    valor_porcent_desc numeric(38,2),
    valor_real_des numeric(38,2)
);
...
--
-- TOC entry 209 (class 1259 OID 16817)
...
--
-- TOC entry 212 (class 1259 OID 16850)
...
--
-- TOC entry 215 (class 1259 OID 16889)
...
--
-- TOC entry 193 (class 1259 OID 16569)
...
--
-- TOC entry 194 (class 1259 OID 16576)
...
--
-- TOC entry 192 (class 1259 OID 16558)
...
--
-- TOC entry 196 (class 1259 OID 16630)
...
--
-- TOC entry 198 (class 1259 OID 16649)
...
--
-- TOC entry 200 (class 1259 OID 16669)
...
--
-- TOC entry 189 (class 1259 OID 16501)
...
--
-- TOC entry 2310 (class 0 OID 16459)
-- Dependencies: 186
...
--
-- TOC entry 2329 (class 0 OID 16765)
-- Dependencies: 205
-- Data for Name: avaliacao_produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.avaliacao_produto (id, descricao, nota, pessoa_id, produto_id) VALUES (5, 'teste avaliacao produto trigger', 10, 1, 1);
INSERT INTO public.avaliacao_produto (id, descricao, nota, pessoa_id, produto_id) VALUES (6, 'teste avaliacao produto trigger', 10, 1, 1);


--
-- TOC entry 2307 (class 0 OID 16445)
-- Dependencies: 183
...
--
-- TOC entry 2330 (class 0 OID 16775)
-- Dependencies: 206
...
--
-- TOC entry 2331 (class 0 OID 16789)
-- Dependencies: 207
...
--
-- TOC entry 2332 (class 0 OID 16798)
-- Dependencies: 208
...
--
-- TOC entry 2333 (class 0 OID 16817)
-- Dependencies: 209
...
--
-- TOC entry 2334 (class 0 OID 16822)
-- Dependencies: 210
...
--
-- TOC entry 2336 (class 0 OID 16850)
-- Dependencies: 212
...
--
-- TOC entry 2337 (class 0 OID 16855)
-- Dependencies: 213
...
--
-- TOC entry 2338 (class 0 OID 16860)
-- Dependencies: 214
...
--
-- TOC entry 2339 (class 0 OID 16889)
-- Dependencies: 215
...
--
-- TOC entry 2340 (class 0 OID 16897)
-- Dependencies: 216
...
--
-- TOC entry 2341 (class 0 OID 16953)
-- Dependencies: 217
-- Data for Name: pessoa_fisica; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.pessoa_fisica (id, email, nome, telefone, cpf, data_nascimento) VALUES (1, 'piumhi10@gmail.com', '37999211089', '05609546621', '33498349382', '1980-10-10');


--
-- TOC entry 2342 (class 0 OID 16961)
-- Dependencies: 218
...
--
-- TOC entry 2343 (class 0 OID 16969)
-- Dependencies: 219
-- Data for Name: produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.produto (id, qtd_estoque, qtde_alerta_estoque, alerta_qtde_estoque, altura, ativo, descricao, largura, link_youtube, nome, peso, profundidade, qtde_clique, tipo_unidade, valor_venda) VALUES (1, 1, 1, true, 10, true, 'produto_teste', 50.200000000000003, 'youtube', 'nome produto', 50, 80.799999999999997, 50, 'UN', 50.00);
INSERT INTO public.produto (id, qtd_estoque, qtde_alerta_estoque, alerta_qtde_estoque, altura, ativo, descricao, largura, link_youtube, nome, peso, profundidade, qtde_clique, tipo_unidade, valor_venda) VALUES (2, 1, 1, true, 10, true, 'produto_teste', 50.200000000000003, 'youtube', 'nome produto', 50, 80.799999999999997, 50, 'UN', 50.00);
...
--
-- TOC entry 2323 (class 0 OID 16661)
-- Dependencies: 199
...
--
-- TOC entry 2313 (class 0 OID 16501)
-- Dependencies: 189
...
--
-- TOC entry 2117 (class 2606 OID 16463)
...
--
-- TOC entry 2123 (class 2606 OID 16769)
...
--
-- TOC entry 2115 (class 2606 OID 16449)
...
--
-- TOC entry 2125 (class 2606 OID 16783)
...
--
-- TOC entry 2127 (class 2606 OID 16797)
...
--
-- TOC entry 2135 (class 2606 OID 16844)
...
--
-- TOC entry 2129 (class 2606 OID 16806)
...
--
-- TOC entry 2131 (class 2606 OID 16821)
...
--
-- TOC entry 2133 (class 2606 OID 16829)
...
--
-- TOC entry 2137 (class 2606 OID 16854)
...
--
-- TOC entry 2139 (class 2606 OID 16859)
...
--
-- TOC entry 2141 (class 2606 OID 16867)
...
--
-- TOC entry 2143 (class 2606 OID 16896)
...
--
-- TOC entry 2147 (class 2606 OID 16901)
...
--
-- TOC entry 2153 (class 2606 OID 16976)
...
--
-- TOC entry 2121 (class 2606 OID 16668)
...
--
-- TOC entry 2145 (class 2606 OID 16911)
...
--
-- TOC entry 2157 (class 2606 OID 17012)
...
--
-- TOC entry 2119 (class 2606 OID 16505)
...
--
-- TOC entry 2155 (class 2606 OID 17005)
...
--
-- TOC entry 2159 (class 2606 OID 17010)
...
--
-- TOC entry 2188 (class 2620 OID 17074)
-- Name: validachavepessoa; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2190 (class 2620 OID 17076)
-- Name: validachavepessoa; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2187 (class 2620 OID 17073)
-- Name: validachavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2189 (class 2620 OID 17075)
-- Name: validachavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2191 (class 2620 OID 17077)
-- Name: validachavepessoa2; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2177 (class 2620 OID 17059)
...
--
-- TOC entry 2176 (class 2620 OID 17060)
...
--
-- TOC entry 2178 (class 2620 OID 17061)
...
--
-- TOC entry 2179 (class 2620 OID 17063)
...
--
-- TOC entry 2180 (class 2620 OID 17066)
...
--
-- TOC entry 2161 (class 2606 OID 16510)
...
--
-- TOC entry 2167 (class 2606 OID 16878)
...
--
-- TOC entry 2172 (class 2606 OID 17038)
...
--
-- TOC entry 2173 (class 2606 OID 17043)
...
--
-- TOC entry 2174 (class 2606 OID 17048)
...
--
-- TOC entry 2169 (class 2606 OID 16917)
...
--
-- TOC entry 2175 (class 2606 OID 17053)
...
--
-- TOC entry 2163 (class 2606 OID 16977)
...
--
-- TOC entry 2164 (class 2606 OID 16982)
-- Name: produto_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2166 (class 2606 OID 16987)
-- Name: produto_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2170 (class 2606 OID 16992)
-- Name: produto_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2160 (class 2606 OID 17028)
...
--
-- TOC entry 2168 (class 2606 OID 17018)
...
--
-- TOC entry 2162 (class 2606 OID 17023)
-- Name: venda_compra_loja_virt_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2165 (class 2606 OID 17013)
...
-- Completed on 2024-02-12 18:11:59
